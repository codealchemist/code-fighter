process.env.NODE_ENV = 'test' // Supress logging from app.
...
describe('oauth2.js', () => {
  ...
  it(`should start authorization`, (done) => {
    ...
    const app = proxyquire(resolve('src/index'), {
      passport: passportMock,
      './lib/oauth2': proxyquire(resolve('src/lib/oauth2'), {
        passport: passportMock
      })
    })
  ...
  it(`should finish authorization`, (done) => {
    const oauth2 = proxyquire(resolve('src/lib/oauth2'), {
      passport: passportMock
    })
    const app = proxyquire(resolve('src/index'), {
      passport: passportMock,
